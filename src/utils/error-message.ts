export const ERROR_MESSAGE = {
    CANNOT_FIND_ONE_USER: { code: 1001, message: '사용자의 상세를 찾지 못했습니다.' },
    ALREADY_CREATED_USER_EMAIL: { code: 1002, message: '이미 사용된 이메일입니다.' },
    FAIL_AUTH: { code: 1003, message: '인증에 실패하였습니다.' },
    ...
    CANNOT_FIND_IMG_URL: { code: 1008, message: '해당 프로필 사진을 찾지 못했습니다.' },
};
